...
void TypeChecker::check(ayla::ast::AstNode *node) {
  ...
  switch (node->kind) {
  case core::ast::NodeKind::ExpressionStatement: check_expression_statement(static_cast<core::ast::ExpressionStatementNode *>(node)); break;
  case core::ast::NodeKind::Identifier: check_identifier(static_cast<core::ast::IdentifierNode *>(node)); break;
  case core::ast::NodeKind::NumberLiteral: check_number_literal(static_cast<parser::node::NumberLiteralNode *>(node)); break;
  case core::ast::NodeKind::StringLiteral: check_string_literal(static_cast<parser::node::StringLiteralNode *>(node)); break;
  case core::ast::NodeKind::BooleanLiteral: check_boolean_literal(static_cast<parser::node::BoolLiteralNode *>(node)); break;
  case core::ast::NodeKind::ArrayLiteral: check_array_literal(static_cast<parser::node::ASTArrayLiteralNode *>(node)); break;
  case core::ast::NodeKind::ObjectLiteral: check_object_literal(static_cast<parser::node::ObjectLiteralNode *>(node)); break;
  case core::ast::NodeKind::VariableDeclaration: check_variable_declaration(static_cast<core::ast::PatternNode *>(node)); break;
  case core::ast::NodeKind::FunctionDeclaration: check_function_declaration(static_cast<parser::node::FunctionDeclarationNode *>(node)); break;
  case core::ast::NodeKind::FunctionCall: check_function_call(static_cast<parser::node::FunctionCallNode *>(node)); break;
  case core::ast::NodeKind::BinaryExpression: check_binary_expression(static_cast<parser::node::BinaryExpressionNode *>(node)); break;
  case core::ast::NodeKind::MemberAccess: check_member_access(static_cast<parser::node::MemberAccessNode *>(node)); break;
  case core::ast::NodeKind::IndexAccess: check_index_access(static_cast<parser::node::IndexAccessNode *>(node)); break;
  case core::ast::NodeKind::Assignment: check_assignment(dynamic_cast<parser::node::statement::AssignmentNode *>(node)); break;
...
void TypeChecker::check_expression_statement(core::ast::ExpressionStatementNode *node) {
...
void TypeChecker::check_variable_declaration(core::ast::PatternNode *node) {
  if (!node) return;
...
void TypeChecker::check_binary_expression(parser::node::BinaryExpressionNode *node) {
  ...
  switch (node->op) {
  case core::ast::BinaryOperation::Add:
  case core::ast::BinaryOperation::Subtract:
  case core::ast::BinaryOperation::Multiply:
  case core::ast::BinaryOperation::Divide:
    ...
    break;
  case core::ast::BinaryOperation::And:
  case core::ast::BinaryOperation::Or:
...
void TypeChecker::check_assignment(parser::node::statement::AssignmentNode *node) {
  ...
  case core::ast::NodeKind::Identifier: {
    auto *idNode = static_cast<core::ast::IdentifierNode *>(node->target);
    targetType = idNode->inferred_type ? idNode->inferred_type : &BuiltinTypes::Unknown;
    break;
  }

  case core::ast::NodeKind::MemberAccess: {
  ...
  case core::ast::NodeKind::IndexAccess: {
