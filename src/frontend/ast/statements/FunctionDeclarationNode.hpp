...
struct FunctionDeclarationNode : StatementNode {
  ...
  parser::node::BlockStatementNode *body;
  Modifiers modifiers;
  SymbolId symbol_id;

  FunctionDeclarationNode(IdentifierNode *identifier, std::vector<PatternNode *> params, TypeNode *ret_type = nullptr, parser::node::BlockStatementNode *b = nullptr, Modifiers mods = {})
