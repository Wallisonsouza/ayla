...
void AstDumper::dump_function_declaration(const celestia::ast::node::FunctionDeclarationNode *node) {
...
void AstDumper::dump_variable_declaration(const celestia::ast::node::VariableDeclarationNode *node) {
...
void AstDumper::dump_module_declaration(const celestia::ast::node::ModuleDeclarationNode *node) {
