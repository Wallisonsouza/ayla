...
void Resolver::resolve(ayla::ast::AstNode *node) {
  ...
  case ayla::ast::NodeKind::ImportStatement:
    resolve_import_statement(static_cast<ayla::ast::node::ImportStatementNode *>(node));
    break;

  case ayla::ast::NodeKind::IdentifierExpression:
  ...
  case ayla::ast::NodeKind::AssignmentExpression:
  ...
  case ayla::ast::NodeKind::IndexAccessExpression:
