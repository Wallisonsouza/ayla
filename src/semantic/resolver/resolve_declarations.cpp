...
void Resolver::module_declaration(ayla::ast::node::ModuleDeclarationNode *node) {
...
void Resolver::import_declaration(ayla::ast::node::ImportDeclarationNode *node) {
...
void Resolver::function_declaration(ayla::ast::node::FunctionDeclarationNode *node) {
...
void Resolver::variable_declaration(ayla::ast::node::VariableDeclarationNode *node) {
