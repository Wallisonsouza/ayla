...
void ayla::semantic::Resolver::resolve_module_declaration(ayla::ast::node::ModuleDeclarationNode *node) {
...
void ayla::semantic::Resolver::resolve_variable_declaration(ayla::ast::node::VariableDeclarationNode *node) {
  if (!node) return;
...
void ayla::semantic::Resolver::resolve_function_declaration(ayla::ast::node::FunctionDeclarationNode *node) {
  if (!node) return;
