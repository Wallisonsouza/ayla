...
void ayla::semantic::Resolver::resolve_block_statement(ayla::ast::node::BlockStatementNode *node, bool create_scope) {
  if (!node) return;
...
void ayla::semantic::Resolver::resolve_return_statement(ayla::ast::node::ReturnStatementNode *node) {
  if (!node) return;
...
void ayla::semantic::Resolver::resolve_expression_statement(ayla::ast::node::ExpressionStatementNode *node) {

  if (node->expression) { resolve(node->expression); }
}

void ayla::semantic::Resolver::resolve_if_statement(ayla::ast::node::IfStatementNode *node) {
  if (!node) return;
...
void ayla::semantic::Resolver::resolve_while_statement(ayla::ast::node::WhileStatementNode *node) {
  if (!node) return;
...
void ayla::semantic::Resolver::resolve_import_statement(ayla::ast::node::ImportStatementNode *node) {
